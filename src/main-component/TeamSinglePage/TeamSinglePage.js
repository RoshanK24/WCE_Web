...
const TeamSinglePage = (props) => {
    ...
    return (
        <Fragment>
            ...
            <section className="team-signle py-[3rem]">
                <div className="container">
                    <div className="team-single__inner">
                            ...
                            <div className="row align-items-end">
                                ...
                                <div className="col-xl-5 col-lg-6">
                                    <div className="team-single__info">
                                        <h3 className="title mb-4">{TeamDetails.name}</h3>
                                        <ul className="info list-unstyled mb-30">
                        ...
                        <div className="team-single__content pt-6">
                            <h3 className='mb-2'>Personal experience</h3>
                            <p>Since embarking on my journey as an Immigration Visa Specialist at WCE in 2005 my professional expertise has expanded across a vast spectrum of intricacies within this dynamic field. As a dedicated immigration visa specialist, my focal point revolves around harnessing a multitude of skills to extend comprehensive guidance and support to individuals embarking.. </p>
                            <p className='mb-3'>So, welcome to this expedition—an expedition fueled by dedication, a panoramic view of expertise, and an unrelenting determination to escort individuals through the intricate passages of immigration. This journey shares a common thread with web design—precision. Just as web designers carefully .</p>
                            ...
                            <h3 className='mb-3'>Career guidelines</h3>
                            ...
                            <div className="team-single__contact mt-[3rem]">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="xb-item--field">
                                                ...
                                                <div className="field-inner pos-rel">
                                                    ...
                                                    <input id="email" type="email" placeholder="worldconnectedu@gmail.com" required/>
                                                </div>
                                            </div>
                                        </div>
